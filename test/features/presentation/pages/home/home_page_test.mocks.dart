...
// in note_app/test/features/presentation/pages/home/home_page_test.dart.
...
import 'package:note_app/core/core.dart' as _i14;
...
import 'package:note_app/features/presentation/blocs/note/note_bloc.dart'
    as _i8;
import 'package:note_app/features/presentation/blocs/status_icons/status_icons_cubit.dart'
    as _i13;
...
/// A class which mocks [StatusIconsCubit].
///
/// See the documentation for Mockito's code generation for more information.
class MockStatusIconsCubit extends _i1.Mock implements _i13.StatusIconsCubit {
  MockStatusIconsCubit() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i13.StatusIconsState get state => (super.noSuchMethod(
        Invocation.getter(#state),
        returnValue: _i10.dummyValue<_i13.StatusIconsState>(
          this,
          Invocation.getter(#state),
        ),
      ) as _i13.StatusIconsState);

  @override
  _i11.Stream<_i13.StatusIconsState> get stream => (super.noSuchMethod(
        Invocation.getter(#stream),
        returnValue: _i11.Stream<_i13.StatusIconsState>.empty(),
      ) as _i11.Stream<_i13.StatusIconsState>);
  ...
  @override
  void toggleIconsStatus(_i9.Note? currentNote) => super.noSuchMethod(
        Invocation.method(
          #toggleIconsStatus,
          [currentNote],
        ),
  ...
  @override
  void toggleIconPinnedStatus(_i14.StatusNote? currentStatus) =>
      super.noSuchMethod(
        Invocation.method(
          #toggleIconPinnedStatus,
          [currentStatus],
        ),
        returnValueForMissingStub: null,
      );
  ...
  @override
  void emit(_i13.StatusIconsState? state) => super.noSuchMethod(
        Invocation.method(
          #emit,
          [state],
        ),
  ...
  @override
  void onChange(_i12.Change<_i13.StatusIconsState>? change) =>
      super.noSuchMethod(
        Invocation.method(
          #onChange,
          [change],
